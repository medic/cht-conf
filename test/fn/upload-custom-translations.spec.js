...
describe('upload-custom-translations', () => {
  ...
  describe('medic-2.x', () => {
    ...
    it('should upload simple translations', () => {
      return uploadCustomTranslations(`${testProjectDir}simple`, api.db, api.api)
    ...
    it('should upload translations for multiple languages', () => {
      return uploadCustomTranslations(`${testProjectDir}multi-lang`, api.db, api.api)
    ...
    it('should upload translations containing equals signs', () => {
      return uploadCustomTranslations(`${testProjectDir}contains-equals`, api.db, api.api)
        .then(() => expectTranslationDocs('en'))
        .then(() => getTranslationDoc('en'))
        .then(messagesEn => {
    ...
    it('should work correctly when falling back to testing messages-en', () => {
      return api.db
        ...
        .then(() => uploadCustomTranslations(`${testProjectDir}custom-lang`, api.db, api.api))
        .then(() => expectTranslationDocs('en', 'fr'))
        .then(() => getTranslationDoc('en'))
        .then(messagesEn => {
    ...
    describe('3.0.0', () => {
      ...
      it('should merge with existent translations', () => {
        return api.db
          ...
          .then(() => uploadCustomTranslations(`${testProjectDir}with-customs`, api.db, api.api))
          .then(() => expectTranslationDocs('en'))
          .then(() => getTranslationDoc('en'))
          .then(messagesEn => {
    ...
    describe('3.4.0', () => {
      ...
      it('should replace delete custom values', () => {
        return api.db
          ...
          .then(() => uploadCustomTranslations(`${testProjectDir}no-customs`, api.db, api.api))
          .then(() => expectTranslationDocs('en'))
          .then(() => getTranslationDoc('en'))
          .then(messagesEn => {
            assert.deepEqual(messagesEn.generic, { a: 'first' });
